...
\begin{document}
  \begin{tikzpicture}
    ...
    xmin=0, xmax=100, ymin=0, ymax=5.5, 
    xlabel={Time [h]}, 
    ...
    legend cell align=left
      ...
      \addplot[forget plot]graphics[xmin=0, xmax=70, ymin=0, ymax=5]{comparisonDens.pdf};
      ...
      \addlegendimage{empty legend} \addlegendentry{\hspace{-0.35cm}Porosity}
      \addlegendimage{no markers,color=clrE,line width=1} \addlegendentry{10.7 \%}
      \addlegendimage{no markers,color=clrD,line width=1} \addlegendentry{9.8 \%}
      \addlegendimage{no markers,color=clrC,line width=1} \addlegendentry{8.9 \%}
      \addlegendimage{no markers,color=clrB,line width=1} \addlegendentry{8.0 \%}
      \addlegendimage{no markers,color=clrA,line width=1} \addlegendentry{5.4 \%}
    \end{axis}
    \node[right] at ($(c)+(0.05\plotwidth,\plotheight-0.4cm)$){\small Initial conc. = 5 mM};
    ...
    \begin{axis} 
      ...
      at={(c)}, width=\plotwidth, height=\plotheight, scale only axis, 
      xmin=4, xmax=12, ymin=0, ymax=0.75, 
      ...
      legend style={font=\fontsize{8}{8}\selectfont}
        ...
        \addplot[forget plot]graphics[xmin=4, xmax=12, ymin=0, ymax=0.75]{Jdens.pdf};
