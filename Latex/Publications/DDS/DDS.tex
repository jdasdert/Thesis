...
\begin{table}[h!]
  ...
  \begin{tabular}{ |@{}p{0.4\textwidth}@{} p{0.035\textwidth} | @{}c@{} | }
    ...
    \begin{tabular}[t]{ p{2.1cm} c c }
      ...
      \rowcolor{gray1}
      \small Reservoir volume & \multirow{2}{*}{$V_\R$} & \multirow{2}{*}{3.5 µL} \\
      \rowcolor{white}
      \small Initial concentration & \multirow{2}{*}{$c$} & \multirow{2}{*}{100 mM} \\
      \rowcolor{gray1}
      \small Cavity volume & \multirow{2}{*}{$V_\C$} & \multirow{2}{*}{3500 µL} \\ 
    \end{tabular} & &
    \begin{tabular}[t]{c}
      \rowcolor{gray2}
